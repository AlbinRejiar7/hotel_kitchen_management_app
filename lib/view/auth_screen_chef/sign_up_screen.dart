...
class SignUpPageChef extends StatefulWidget {
  const SignUpPageChef({super.key});

  @override
  State<SignUpPageChef> createState() => _SignUpPageChefState();
}

class _SignUpPageChefState extends State<SignUpPageChef> {
  ...
  void submitForm(LoadingProvider isloadingprovider) async {
    if (formKey.currentState!.validate()) {
      ...
      try {
        ...
        await FirebaseFirestore.instance.collection("chefs").doc(uid).set({
          "id": uid,
        ...
        Navigator.of(context)
            .pushReplacement(SlidePageRoute(page: SingInPageChef()));
